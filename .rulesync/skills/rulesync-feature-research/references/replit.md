...
| ------------- | ---------------------------------------------------- | ------------------------------------------------------------------------------ |
| index         | `https://docs.replit.com/features/agent`        | Replit Agent documentation                                                     |
| `rules`       | `https://docs.replit.com/features/agent`        | Replit Agent project context                                                   |
...
| `skills`      | `https://docs.replit.com/features/agent/skills` | Project `/.agents/skills`, Agent Skills standard, Skills pane and `npx skills` |
