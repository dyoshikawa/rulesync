...
| `rules`       | `https://docs.cline.bot/`                              | Rules, workflows, `.clinerules`, and customization surfaces                      |
| `ignore`      | `https://docs.cline.bot/`                              | `.clineignore` customization surface                                             |
| `mcp`         | `https://docs.cline.bot/cline-cli/configuration`       | `cline_mcp_settings.json`, stdio/HTTP/SSE style MCP server entries               |
| `commands`    | `https://docs.cline.bot/core-workflows/using-commands` | Slash commands and workflow-style reusable commands                              |
| `skills`      | `https://docs.cline.bot/features/skills`               | `.cline/skills`, `~/.cline/skills`, `.clinerules/skills`, `.claude/skills`       |
| `permissions` | `https://docs.cline.bot/features`                      | Auto approve settings for read, edit, commands, browser, MCP, and request limits |
...
| Surface       | Anchor                                                                                                                      |
| ------------- | --------------------------------------------------------------------------------------------------------------------------- |
| `rules`       | Cline rule conversion and `.cline/rules` style output in `cline-rule.ts`                                                    |
