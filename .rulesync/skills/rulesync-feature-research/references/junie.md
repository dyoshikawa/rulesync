...
| `rules`       | `https://junie.jetbrains.com/docs/junie-ide-plugin.html`            | `.junie/AGENTS.md` (used exclusively when present), root `AGENTS.md` + `.junie/playbook.md` + `.junie/rules/*.md`, legacy guidelines                                                                                                       |
...
| `skills`      | `https://junie.jetbrains.com/docs/agent-skills.html`                | `.junie/skills` plus the shared `.agents/skills` roots (import-only), and `--skill-location` / `skill-locations` custom folders (out of scope)                                                                                             |
