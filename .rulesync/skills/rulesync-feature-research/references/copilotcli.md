...
| `ignore`      | No dedicated upstream ignore surface found                                                              | No Rulesync-supported Copilot CLI ignore target                                                                                        |
...
| `commands`    | No dedicated upstream commands surface found                                                            | No Rulesync-supported Copilot CLI commands target                                                                                      |
...
| `permissions` | No Rulesync-supported Copilot CLI permissions adapter                                                                      |
