...
| `rules`       | `https://zed.dev/docs/ai/rules.html`         | `.rules`, AGENTS.md-compatible files, Rules Library; no Rulesync Zed rules target |
| `ignore`      | `https://zed.dev/docs/configuring-zed`       | `.zed/settings.json`, `private_files` glob list                                   |
