...
| `rules`       | `https://docs.roocode.com/`                  | `.roo/rules`, `.roorules`, mode-specific rules, AGENTS.md compatibility                  |
| `ignore`      | `https://docs.roocode.com/`                  | `.rooignore` file surface                                                                |
| `mcp`         | `https://docs.roocode.com/`                  | MCP server configuration                                                                 |
| `commands`    | `https://docs.roocode.com/`                  | `.roo/commands` reusable command files                                                   |
| `subagents`   | `https://docs.roocode.com/`                  | Custom modes / orchestrator-style delegation; Rulesync maps this as simulated subagents  |
| `skills`      | `https://docs.roocode.com/`                  | Roo skills surface                                                                       |
