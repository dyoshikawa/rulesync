---
name: draft-issue-to-external-repository
description: >-
...
3. Report the path to the user and explain how to post (web UI paste, or re-authenticate `gh` with `gh auth login --web` and let this skill retry).
