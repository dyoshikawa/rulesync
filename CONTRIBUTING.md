...
- For external contributors, keep the number of added lines in a PR under 400. This limit is automatically enforced — PRs exceeding it will be closed by our CI.
