...
| `steps`       | positive integer | Maximum agentic iterations before a text-only response is forced (`null` clears; earlier Rulesync versions took a list of step objects here, which Kilo never accepted) |
