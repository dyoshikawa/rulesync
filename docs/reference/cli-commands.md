...
- A skill directory Rulesync cannot read or delete from is reported and skipped. The files it already wrote are kept, and the rest of the skills are still pruned.
