...
- Claude Code ignore and permissions cannot be generated or imported together. When combined, Rulesync skips Claude Code permissions and continues; run them separately to include both.
