...
export default defineConfig({
  test: {
    ...
    // Hermes, Kimi and deepagents users this code targets are the most likely
    // to do — would otherwise see unrelated specs fail on `pnpm cicheck`. Specs
    // that exercise the overrides set them explicitly at runtime.
    env: {
      HERMES_HOME: "",
      KIMI_CODE_HOME: "",
      DEEPAGENTS_HOME: "",
