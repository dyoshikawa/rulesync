...
describe("generate", () => {
  ...
  it("should probe checkRulesyncDirExists against config.getInputRoots() rather than each outputRoot", async () => {
    ...
    expect(checkRulesyncDirExists).toHaveBeenCalledWith({ inputRoots: inputRootsMock });
  });
