 ...
 * describes them: the personal `~/.config/poolside/AGENTS.md` (honouring
 * `XDG_CONFIG_HOME`), the project-root `AGENTS.md`, and nested per-directory
...
/** Instruction file name Pool reads at every scope. */
export const POOL_RULE_FILE_NAME = "AGENTS.md";
