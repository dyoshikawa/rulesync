...
export const AMP_PLUGINS_PROJECT_DIR = join(AMP_DIR, "plugins");
export const AMP_PLUGINS_GLOBAL_DIR = join(AMP_GLOBAL_DIR, "plugins");
...
export const AMP_HOOKS_FILE_NAME = "rulesync-hooks.ts";
