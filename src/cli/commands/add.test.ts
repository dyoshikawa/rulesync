...
describe("addCommand", () => {
  ...
  describe("feature scaffolding", () => {
    ...
    it.each([
      {
        source: "mcp",
        relativeFilePath: RULESYNC_MCP_LEGACY_RELATIVE_FILE_PATH,
        expectedContent: '"mcpServers"',
      },
      {
        source: "mcp",
      ...
      {
        source: "hooks",
        relativeFilePath: RULESYNC_HOOKS_LEGACY_RELATIVE_FILE_PATH,
        expectedContent: '"hooks"',
      },
      {
        source: "ignore",
      ...
      {
        source: "permissions",
        relativeFilePath: RULESYNC_PERMISSIONS_LEGACY_RELATIVE_FILE_PATH,
        expectedContent: '"permission"',
      },
    ])(
