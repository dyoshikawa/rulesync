...
`;
            ...
            expect(logger.success).toHaveBeenCalledWith(
                ".gitignore is already up to date",
            );
    ...
    describe("error handling", () => {
        it("should handle file existence check errors", async () => {
            vi.mocked(fileExists).mockRejectedValue(
        ...
        it("should handle file read errors", async () => {
            vi.mocked(fileExists).mockResolvedValue(true);
            vi.mocked(readFileContent).mockRejectedValue(
        ...
        it("should handle file write errors", async () => {
            vi.mocked(fileExists).mockResolvedValue(false);
            vi.mocked(writeFileContent).mockRejectedValue(
