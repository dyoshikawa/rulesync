...
export class AntigravityRule extends ToolRule {
  ...
  static getSettablePaths(
    ...
    return {
      nonRoot: {
        relativeDirPath: buildToolPath(ANTIGRAVITY_LEGACY_DIR, "rules", _options.excludeToolDir),
      },
    };
  }
  ...
  static async fromFile({
    ...
    const filePath = join(outputRoot, ANTIGRAVITY_LEGACY_RULES_DIR_PATH, relativeFilePath);
