...
describe("generateMcpConfigurations", () => {
  ...
  it("should generate configurations for all default targets", async () => {
    ...
    // Total: amazonqcli(1) + augmentcode+claudecode(1) + cursor(1) + cline(1) + codexcli(1) + opencode(1) + qwencode(1) + roo(1) + copilot(2) + geminicli(1) + kiro(1) + junie(1) + windsurf(1) = 14
    ...
    expect(filepaths).toContain(join(testDir, "opencode.json"));
