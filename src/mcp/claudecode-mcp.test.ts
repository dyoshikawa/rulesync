...
describe("ClaudecodeMcp", () => {
  ...
  describe("fromRulesyncMcp", () => {
    ...
    it("should create instance from RulesyncMcp with custom baseDir", () => {
      ...
      expect(claudecodeMcp.getFilePath()).toBe("/target/dir/.mcp.json");
      expect(claudecodeMcp.getJson()).toEqual(jsonData);
    });
  ...
  describe("integration", () => {
    it("should handle complete workflow: fromFile -> toRulesyncMcp -> fromRulesyncMcp", async () => {
      ...
      const newClaudecodeMcp = ClaudecodeMcp.fromRulesyncMcp({
        baseDir: testDir,
        rulesyncMcp,
      });
    ...
    it("should maintain data consistency across transformations", () => {
      ...
      expect(newClaudecodeMcp.getJson()).toEqual(complexJsonData);
      expect(newClaudecodeMcp.getFilePath()).toBe("/project/.mcp.json");
    });
  });
});
