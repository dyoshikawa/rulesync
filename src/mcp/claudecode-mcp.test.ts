...
describe("ClaudecodeMcp", () => {
  ...
  describe("modular-mcp integration", () => {
    it("should create instance from file with modularMcp enabled", async () => {
      const jsonData = {
        mcpServers: {
          filesystem: {
            command: "npx",
      ...
      expect(claudecodeMcp).toBeInstanceOf(ClaudecodeMcp);
      expect(claudecodeMcp.getJson()).toEqual(jsonData);
      expect(claudecodeMcp.getModularMcpFile()).toBeDefined();
    });

    it("should set modular-mcp file when modularMcp is enabled", async () => {
      const jsonData = {
        mcpServers: {
          "test-server": {
            command: "node",
      ...
      const modularMcpFile = claudecodeMcp.getModularMcpFile();
      expect(modularMcpFile).toBeDefined();
      expect(modularMcpFile?.getRelativeFilePath()).toBe("modular-mcp.json");
      expect(modularMcpFile?.getRelativeDirPath()).toBe(".");
    });

    it("should not set modular-mcp file when modularMcp is disabled", async () => {
      const jsonData = {
        mcpServers: {
          "test-server": {
            command: "node",
      ...
      expect(claudecodeMcp.getModularMcpFile()).toBeUndefined();
    });

    it("should create instance from RulesyncMcp with modularMcp enabled", async () => {
    ...
    it("should generate proxy config in .mcp.json when modularMcp is enabled", async () => {
      const rulesyncMcpData = {
        mcpServers: {
          "test-server": {
            command: "node",
      ...
      expect((json.mcpServers as any)["modular-mcp"]).toEqual({
        type: "stdio",
        command: "npx",
    ...
    it("should generate modular-mcp.json with actual server configs when modularMcp is enabled", async () => {
      const rulesyncMcpData = {
        mcpServers: {
          "test-server": {
            command: "node",
      ...
      const modularMcpJson = modularMcpFile?.getJson();
      expect(modularMcpJson).toHaveProperty("mcpServers");
      expect((modularMcpJson as any).mcpServers).toEqual(rulesyncMcpData.mcpServers);
    });

    it("should preserve description fields in modular-mcp.json", async () => {
      const rulesyncMcpData = {
        mcpServers: {
          "test-server": {
            command: "node",
      ...
      expect((modularMcpJson as any).mcpServers["test-server"]).toHaveProperty(
        "description",
        "Test server description",
      );
    });

    it("should not generate modular-mcp.json when modularMcp is disabled", async () => {
      const rulesyncMcpData = {
        mcpServers: {
          "test-server": {
            command: "node",
      ...
      expect((json.mcpServers as any)["test-server"]).toBeDefined();
      expect((json.mcpServers as any)["test-server"]).not.toHaveProperty("description");
    });

    it("should handle modularMcp in global mode", async () => {
      const rulesyncMcpData = {
        mcpServers: {
          "global-server": {
            command: "node",
    ...
    it("should allow manual setting of modular-mcp file", async () => {
      const claudecodeMcp = new ClaudecodeMcp({
        relativeDirPath: ".",
        relativeFilePath: ".mcp.json",
      ...
      const { ModularMcp } = await import("./modular-mcp.js");
      ...
      expect(claudecodeMcp.getModularMcpFile()).toBe(modularMcpFile);
    });
  });
});
